...
namespace ILRuntime.Runtime.Generated
{
    unsafe class AssetBundles_ResourceAsyncOperation_Binding
    {
        ...
        static StackObject* get_progress_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            AssetBundles.ResourceAsyncOperation instance_of_this_method = (AssetBundles.ResourceAsyncOperation)typeof(AssetBundles.ResourceAsyncOperation).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
