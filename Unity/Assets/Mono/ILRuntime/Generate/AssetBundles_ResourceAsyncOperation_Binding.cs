...
{
    unsafe class AssetBundles_ResourceAsyncOperation_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(AssetBundles.ResourceAsyncOperation);
            args = new Type[]{};
        ...
        static StackObject* get_progress_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            AssetBundles.ResourceAsyncOperation instance_of_this_method = (AssetBundles.ResourceAsyncOperation)typeof(AssetBundles.ResourceAsyncOperation).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
