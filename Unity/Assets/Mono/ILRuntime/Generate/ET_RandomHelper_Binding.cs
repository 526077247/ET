...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_RandomHelper_Binding
    {
            ...
            if (genericMethods.TryGetValue("RandomArray", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.String), typeof(System.String[])))
                    {
                        ...
                        app.RegisterCLRMethodRedirection(method, RandomArray_1);
        ...
        static StackObject* RandomArray_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
