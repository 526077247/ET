...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_ETTask_1_UpdateConfig_Binding
    {
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.ETTask<ET.UpdateConfig> instance_of_this_method = (ET.ETTask<ET.UpdateConfig>)typeof(ET.ETTask<ET.UpdateConfig>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
