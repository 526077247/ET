...
namespace ILRuntime.Runtime.Generated
{
    unsafe class TMPro_TMP_InputField_Binding
    {
        ...
        static StackObject* get_text_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            TMPro.TMP_InputField instance_of_this_method = (TMPro.TMP_InputField)typeof(TMPro.TMP_InputField).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
