...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_List_1_WhiteConfig_Binding
    {
        ...
        static StackObject* GetEnumerator_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<ET.WhiteConfig> instance_of_this_method = (System.Collections.Generic.List<ET.WhiteConfig>)typeof(System.Collections.Generic.List<ET.WhiteConfig>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
