    ...
    unsafe class LitJson_JsonMapper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("ToObject", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Collections.Generic.List<ET.WhiteConfig>), typeof(System.String)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(ET.UpdateConfig)};
            if (genericMethods.TryGetValue("ToObject", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(ET.UpdateConfig), typeof(System.String)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* ToObject_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LitJson.JsonMapper.ToObject<System.String[]>(@json);
        ...
        static StackObject* ToObject_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LitJson.JsonMapper.ToObject<System.Collections.Generic.List<ET.WhiteConfig>>(@json);
        ...
        static StackObject* ToObject_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LitJson.JsonMapper.ToObject<ET.UpdateConfig>(@json);
