...
{
    unsafe class System_Collections_Generic_Dictionary_2_String_DynamicAtlas_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.String, ET.DynamicAtlas>);
            args = new Type[]{typeof(System.String), typeof(ET.DynamicAtlas).MakeByRefType()};
            ...
            args = new Type[]{typeof(System.String), typeof(ET.DynamicAtlas)};
        ...
        static StackObject* TryGetValue_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.DynamicAtlas @value = (ET.DynamicAtlas)typeof(ET.DynamicAtlas).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            System.Collections.Generic.Dictionary<System.String, ET.DynamicAtlas> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, ET.DynamicAtlas>)typeof(System.Collections.Generic.Dictionary<System.String, ET.DynamicAtlas>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ET.DynamicAtlas[];
        ...
        static StackObject* Add_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ET.DynamicAtlas @value = (ET.DynamicAtlas)typeof(ET.DynamicAtlas).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.String, ET.DynamicAtlas>();
