...
namespace ILRuntime.Runtime.Generated
{
    unsafe class AssetBundles_AssetBundleConfig_Binding
    {
        ...
        static StackObject* SyncLoadGlobalAssetBundle_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            AssetBundles.AssetBundleConfig instance_of_this_method = (AssetBundles.AssetBundleConfig)typeof(AssetBundles.AssetBundleConfig).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
