...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_AppConfig_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRFieldGetter(field, get_jump_channel_0);
            app.RegisterCLRFieldSetter(field, set_jump_channel_0);
            app.RegisterCLRFieldBinding(field, CopyToStack_jump_channel_0, AssignFromStack_jump_channel_0);
            field = type.GetField("app_ver", flag);
            app.RegisterCLRFieldGetter(field, get_app_ver_1);
            app.RegisterCLRFieldSetter(field, set_app_ver_1);
            app.RegisterCLRFieldBinding(field, CopyToStack_app_ver_1, AssignFromStack_app_ver_1);
            field = type.GetField("app_url", flag);
            app.RegisterCLRFieldGetter(field, get_app_url_2);
            app.RegisterCLRFieldSetter(field, set_app_url_2);
            app.RegisterCLRFieldBinding(field, CopyToStack_app_url_2, AssignFromStack_app_url_2);
        ...
        static object get_jump_channel_0(ref object o)
        {
        ...
        static void set_jump_channel_0(ref object o, object v)
        {
        ...
        static object get_app_ver_1(ref object o)
        {
        ...
        static void set_app_ver_1(ref object o, object v)
        {
        ...
        static object get_app_url_2(ref object o)
        {
        ...
        static void set_app_url_2(ref object o, object v)
        {
