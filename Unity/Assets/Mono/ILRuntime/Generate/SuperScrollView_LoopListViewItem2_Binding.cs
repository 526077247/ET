...
namespace ILRuntime.Runtime.Generated
{
    unsafe class SuperScrollView_LoopListViewItem2_Binding
    {
        ...
        static StackObject* get_IsInitHandlerCalled_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            SuperScrollView.LoopListViewItem2 instance_of_this_method = (SuperScrollView.LoopListViewItem2)typeof(SuperScrollView.LoopListViewItem2).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* set_IsInitHandlerCalled_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
