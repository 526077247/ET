...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_ETTask_1_SpriteAtlas_Binding
    {
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.ETTask<UnityEngine.U2D.SpriteAtlas> instance_of_this_method = (ET.ETTask<UnityEngine.U2D.SpriteAtlas>)typeof(ET.ETTask<UnityEngine.U2D.SpriteAtlas>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
