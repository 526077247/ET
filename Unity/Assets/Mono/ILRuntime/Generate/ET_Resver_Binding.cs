...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_Resver_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRFieldGetter(field, get_force_update_0);
            app.RegisterCLRFieldSetter(field, set_force_update_0);
            app.RegisterCLRFieldBinding(field, CopyToStack_force_update_0, AssignFromStack_force_update_0);
            field = type.GetField("channel", flag);
            app.RegisterCLRFieldGetter(field, get_channel_1);
            app.RegisterCLRFieldSetter(field, set_channel_1);
            app.RegisterCLRFieldBinding(field, CopyToStack_channel_1, AssignFromStack_channel_1);
            field = type.GetField("update_tailnumber", flag);
            app.RegisterCLRFieldGetter(field, get_update_tailnumber_2);
            app.RegisterCLRFieldSetter(field, set_update_tailnumber_2);
            app.RegisterCLRFieldBinding(field, CopyToStack_update_tailnumber_2, AssignFromStack_update_tailnumber_2);
        ...
        static object get_force_update_0(ref object o)
        {
            return ((ET.Resver)o).force_update;
        }

        static StackObject* CopyToStack_force_update_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static void set_force_update_0(ref object o, object v)
        {
            ((ET.Resver)o).force_update = (System.Int32)v;
        }

        static StackObject* AssignFromStack_force_update_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
        ...
        static object get_channel_1(ref object o)
        {
            return ((ET.Resver)o).channel;
        }

        static StackObject* CopyToStack_channel_1(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((ET.Resver)o).channel;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_channel_1(ref object o, object v)
        {
        ...
        static object get_update_tailnumber_2(ref object o)
        {
            return ((ET.Resver)o).update_tailnumber;
        }

        static StackObject* CopyToStack_update_tailnumber_2(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((ET.Resver)o).update_tailnumber;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_update_tailnumber_2(ref object o, object v)
        {
