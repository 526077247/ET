...
namespace ILRuntime.Runtime.Generated
{
    unsafe class BestHTTP_HTTPResponse_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("GetFirstHeaderValue", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetFirstHeaderValue_0);
            args = new Type[]{};
        ...
        static StackObject* GetFirstHeaderValue_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetFirstHeaderValue(@name);
