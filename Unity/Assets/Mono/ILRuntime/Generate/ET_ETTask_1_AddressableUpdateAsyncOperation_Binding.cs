...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_ETTask_1_AddressableUpdateAsyncOperation_Binding
    {
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.ETTask<AssetBundles.AddressableUpdateAsyncOperation> instance_of_this_method = (ET.ETTask<AssetBundles.AddressableUpdateAsyncOperation>)typeof(ET.ETTask<AssetBundles.AddressableUpdateAsyncOperation>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
