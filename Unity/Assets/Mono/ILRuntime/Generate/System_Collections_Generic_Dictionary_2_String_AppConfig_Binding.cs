...
{
    unsafe class System_Collections_Generic_Dictionary_2_String_AppConfig_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.String, ET.AppConfig>);
            args = new Type[]{typeof(System.String), typeof(ET.AppConfig).MakeByRefType()};
        ...
        static StackObject* TryGetValue_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.AppConfig @value = (ET.AppConfig)typeof(ET.AppConfig).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
            ...
            System.Collections.Generic.Dictionary<System.String, ET.AppConfig> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, ET.AppConfig>)typeof(System.Collections.Generic.Dictionary<System.String, ET.AppConfig>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ET.AppConfig[];
