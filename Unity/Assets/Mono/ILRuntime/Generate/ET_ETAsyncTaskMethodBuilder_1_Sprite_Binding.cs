...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_ETAsyncTaskMethodBuilder_1_Sprite_Binding
    {
        ...
        static StackObject* AwaitUnsafeOnCompleted_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ET.ETTask<UnityEngine.U2D.SpriteAtlas> @awaiter = (ET.ETTask<UnityEngine.U2D.SpriteAtlas>)typeof(ET.ETTask<UnityEngine.U2D.SpriteAtlas>).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
