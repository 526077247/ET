...
{
    unsafe class ET_ETTask_1_KeyCode_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.ETTask<UnityEngine.KeyCode>);
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ET.ETTask<UnityEngine.KeyCode>.Create(@fromPool);
