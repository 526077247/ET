...
namespace UnityEditor.AddressableAssets.Build.DataBuilders
{
    ...
    public class BuildScriptPackedMode : BuildScriptBase
    {
        ...
        public Dictionary<string, string> m_BundleToInternalId = new Dictionary<string, string>();
        ...
        public static void CopyFileWithTimestampIfDifferent(string srcPath, string destPath)
        {
            if (srcPath == destPath)
                return;
        ...
        public void AddPostCatalogUpdatesInternal(AddressableAssetGroup assetGroup, List<Action> postCatalogUpdates, ContentCatalogDataEntry dataEntry, string targetBundlePath)
        {
        ...
        public static void ReplaceDependencyKeys(string from, string to, List<ContentCatalogDataEntry> locations)
        {
